...
import java.util.List;
    ...
    public class BotCalendar {
         ...
         * Application name.
         */
        private static final String APPLICATION_NAME = "CalendarForBot";
        /**
        ...
        public static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
                throws IOException {
            // Load client secrets.
            InputStream in = BotCalendar.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
            if (in == null) {
        ...
        public List<Event> getEvent() throws IOException, GeneralSecurityException {
