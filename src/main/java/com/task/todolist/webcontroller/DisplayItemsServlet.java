    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response){
        try {
            ...
            if(groceryList.isEmpty())
                ...
                out.println("<tr><th>Item Name</th><th>Qty</th><th>Unit</th><th>Status</th><th>Actions</th></tr>");
                for (GroceryList listitem : groceryList) {
                    ...
                    out.println("<td><button class='edit-button' data-id='" + listItemId + "'>Edit</button>");
                    out.println("<button class='status-button' data-id='" + listItemId + "' data-status='done'>Mark as done</button>");
                    out.println("<button class='status-button-remove' data-id='" + listItemId + "' data-status='remove'>Remove</button></td>");
